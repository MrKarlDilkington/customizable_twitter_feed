...
<div id="ccm-tab-content-feed-details" class="ccm-tab-content">
    ...
    <div class="form-item">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('The Twitter Feed Title is optional.'); ?>"></i>
...
<div id="ccm-tab-content-feed-settings" class="ccm-tab-content">
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('Show the user name, Twitter name, and user thumbnail image.'); ?>"></i>
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('Show the Reply, Retweet, and Favorite links.'); ?>"></i>
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('Add a horizontal divider between tweets.'); ?>"></i>
        <?php echo $form->select('tweetDivider', array(1 => t('on'), 0 => t('off')), $tweetDivider, array('style' => 'width: 125px;')); ?>
    </div>

    <!-- Max Width -->
    <div class="form-item two-columns clear-both">
        <?php echo $form->label('maxWidth', t('Max Width'));?>
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('When a width is not set, or set to 0, the default max-width will be 520px.'); ?>"></i>
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('Add padding to the feed container.'); ?>"></i>
        <div class="input-group pixel-input-width">
...
<div id="ccm-tab-content-text-colors" class="ccm-tab-content">
    ...
    <!-- Feed Theme -->
    <div class="form-item two-columns no-float">
        <?php echo $form->label('feedTheme', t('Feed Theme'));?>
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('Setting a feed theme will override font and divider colors.'); ?>"></i>
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('When a font size is not set, or set to 0, the default font size will be 18px.'); ?>"></i>
        <div class="input-group pixel-input-width">
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('When a font size is not set, or set to 0, the default font size will be 16px.'); ?>"></i>
        <div class="input-group pixel-input-width">
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('When a font size is not set, or set to 0, the default font size will be 14px.'); ?>"></i>
        <div class="input-group pixel-input-width">
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('When a font size is not set, or set to 0, the default font size will be 12px.'); ?>"></i>
        <div class="input-group pixel-input-width">
    ...
    <div class="form-item two-columns">
        ...
        <i class="fa fa-question-circle launch-tooltip" data-original-title="<?php echo t('The Reply Retweet Favorite links. When a font size is not set, or set to 0, the default font size will be 12px.'); ?>"></i>
        <div class="input-group pixel-input-width">
